          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "14px" }}>
            <thead>
              <tr style={{ backgroundColor: "#f9fafb" }}>
                {["SNO", "EMP ID", "Name", "Salary", "Allowance", "Deduction", "Total", "Pay Date"].map((h) => (
              ...
              {filtered.length === 0 ? (
                ...
                filtered.map((sal, index) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "12px 16px", color: "#374151" }}>{sal.employeeId?.employeeId || "-"}</td>
                    <td style={{ padding: "12px 16px", color: "#374151", fontWeight: 500 }}>{sal.employeeId?.name || "-"}</td>
                    ...
                    <td style={{ padding: "12px 16px", color: "#374151", fontWeight: 600 }}>{sal.total?.toLocaleString()}</td>
