      ...
      <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
        ...
        <div style={{ display: "flex", gap: "12px" }}>
          <button
            type="submit"
            disabled={loading}
            style={{ flex: 1, backgroundColor: "#008080", color: "white", border: "none", padding: "10px", borderRadius: "6px", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}
          >
          ...
          <button
            ...
            style={{ flex: 1, backgroundColor: "#6b7280", color: "white", border: "none", padding: "10px", borderRadius: "6px", fontSize: "14px", fontWeight: 600, cursor: "pointer" }}
          >
            Cancel
          </button>
        </div>
