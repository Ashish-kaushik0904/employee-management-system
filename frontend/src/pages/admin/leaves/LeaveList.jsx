    ...
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px", gap: "12px" }}>
        <input
          ...
          style={{ border: "1.5px solid #e2e8f0", borderRadius: "8px", padding: "9px 14px", fontSize: "13px", width: "280px", outline: "none", color: "#374151" }}
        />
                ...
                filtered.map((leave, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td style={{ padding: "14px 16px" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                          {emp?.image ? (
                            ...
                            <div style={{ width: "32px", height: "32px", borderRadius: "50%", backgroundColor: "#2563eb", color: "white", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "13px", fontWeight: 700, flexShrink: 0 }}>
                      ...
                      <td style={{ padding: "14px 16px", color: "#6b7280" }}>{emp?.department?.name || "—"}</td>
                      <td style={{ padding: "14px 16px", color: "#374151", fontWeight: 600 }}>{days}</td>
                      <td style={{ padding: "14px 16px" }}>
                        <span style={{ backgroundColor: s.bg, color: s.color, padding: "4px 12px", borderRadius: "20px", fontSize: "12px", fontWeight: 700, textTransform: "capitalize" }}>
                          {leave.status}
                        </span>
                      </td>
                      <td style={{ padding: "14px 16px" }}>
                        <button
                          ...
                          style={{ backgroundColor: "#2563eb", color: "white", border: "none", padding: "6px 16px", borderRadius: "7px", fontSize: "12px", fontWeight: 600, cursor: "pointer" }}
                        >
                          View
                        </button>
                      </td>
