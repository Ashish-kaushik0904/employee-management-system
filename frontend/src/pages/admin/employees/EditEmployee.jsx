  ...
  return (
    <div style={{ maxWidth: "820px" }}>
      ...
      <div style={{ backgroundColor: "white", borderRadius: "12px", padding: "28px", boxShadow: "0 2px 12px rgba(0,0,0,0.07)" }}>
        ...
        {success && (
          <div style={{ backgroundColor: "#f0fdf4", color: "#16a34a", padding: "10px 14px", borderRadius: "8px", marginBottom: "16px", fontSize: "13px", border: "1px solid #bbf7d0" }}>
            {success}
          </div>
        )}
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px", marginBottom: "24px", padding: "16px", backgroundColor: "#f8fafc", borderRadius: "10px" }}>
          {preview ? (
            <img src={preview} alt="Preview" style={{ width: "80px", height: "80px", borderRadius: "50%", objectFit: "cover", border: "3px solid #2563eb" }} />
          ) : (
            <div style={{ width: "80px", height: "80px", borderRadius: "50%", backgroundColor: "#2563eb", display: "flex", alignItems: "center", justifyContent: "center", color: "white", fontSize: "28px", fontWeight: 700, border: "3px solid white", boxShadow: "0 2px 8px rgba(37,99,235,0.3)" }}>
          ...
          <div>
            ...
            />
            <p style={{ fontSize: "11px", color: "#94a3b8", marginTop: "4px" }}>JPG, PNG up to 5MB</p>
          </div>
        </div>
