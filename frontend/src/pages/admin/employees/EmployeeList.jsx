                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <div style={{ display: "flex", gap: "6px" }}>
                        <button
                          ...
                          style={{ backgroundColor: "#3b82f6", color: "white", border: "none", padding: "5px 10px", borderRadius: "4px", fontSize: "12px", cursor: "pointer" }}
                        >
                          View
                        </button>
                        <button
                          onClick={() => navigate(`/admin-dashboard/employees/edit/${emp._id}`)}
                          style={{ backgroundColor: "#22c55e", color: "white", border: "none", padding: "5px 10px", borderRadius: "4px", fontSize: "12px", cursor: "pointer" }}
                        >
                          Edit
                        </button>
                        <button
                          onClick={() => navigate(`/admin-dashboard/salary/add?employeeId=${emp._id}`)}
                          style={{ backgroundColor: "#f59e0b", color: "white", border: "none", padding: "5px 10px", borderRadius: "4px", fontSize: "12px", cursor: "pointer" }}
                        >
                          Salary
                        </button>
                        <button
                          onClick={() => handleDelete(emp._id)}
                          style={{ backgroundColor: "#ef4444", color: "white", border: "none", padding: "5px 10px", borderRadius: "4px", fontSize: "12px", cursor: "pointer" }}
                        >
                          Delete
                        </button>
                      </div>
